...
config(function($stateProvider) {
		$stateProvider
			.state('root.product_detail', {
				url: 'category/:id/:sub_id/ads/:product_id',
				views: {
					'container@': {
	...
	.controller('ProductDetailCtrl', function($scope, $filter, LANGUAGE, $timeout, WISHLIST, $localStorage, $sce, USER, $stateParams, $state, $q, $rootScope, ERRORTIPS, API, DATA, gettextCatalog, NOTIFIER) {
		...
		$q.all(promises).then(function(){
			...
			$scope.product.share_url = $state.href('root.product_detail', {id:$scope.product.category.slug,
									sub_id: $scope.product.subcategory.slug,
